...
def main(_argv):
    ...
    video_path = './data/video/blur.mp4'
    out = './outputs/test00.avi'
    ...
    #             frame[int(bbox[1]):int(bbox[3]),int(bbox[0]):int(bbox[2])] = cv2.GaussianBlur(frame[int(bbox[1]):int(bbox[3]),int(bbox[0]):int(bbox[2])],(15,15),0)
    #         except:
    #             print("err")
